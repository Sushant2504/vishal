...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Payment Proof Strip (placed above payment info) */}
      ...
      {/* Payment Confidence Section (moved below vision) */}
      <section className="section-padding bg-white -mt-4">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-4 fade-in-on-scroll">
              ...
              <p className="text-lg text-gray-700">
                At Victorious Medical Buyback, we make payments simple and secure so your supplies move without delay.
